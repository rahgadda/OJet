...
module.exports = {
  ...
  resolve: {
    alias: {
      ...
      'ojs': path.resolve(__dirname, './web/js/libs/oj/v7.1.0/debug'),
      'ojtranslations': path.resolve(__dirname, './web/js/libs/oj/v7.1.0/resources'),
    ...
    new WebpackRequireFixupPlugin(
      {
        ...
        baseResourceUrl: "./web/js/libs/oj/v7.1.0"
      }
    )
